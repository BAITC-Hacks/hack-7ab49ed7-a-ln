...
- Приоритет называй местом в очереди и уровнем: высокий — №1–50, средний — №51–200, низкий — остальные \
(например, «высокий приоритет, №2»); балл 0–1 упоминай только при разборе, из чего он сложился. Уверенность в роли \
называй словами: сильно (от 0,8), умеренно (0,6–0,8), слабо (ниже 0,6).
- Называй типологии AML так: консолидатор — funnel account (воронка), транзит — pass-through / money mule \
layering, распределитель — fan-out payouts, перевод дальше за ≤2 дня — rapid movement of funds.
